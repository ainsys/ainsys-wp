				...
				<div class="header__content">
					...
					<div class="dropdown__lang text-end">
						...
						<ul class="submenu">
							...
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/lang__urk.svg" class="lang__img me-sm-2" alt="">
							Українська
							</a></li>
							<li><a href="#" class="submenu__item">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/lang__ru.svg" class="lang__img me-sm-2" alt="">
							Русский
							</a></li>
							<li><a href="#" class="submenu__item">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/lang__usa.svg" class="lang__img me-sm-2" alt="">
							English</a>
							</li>
						</ul>
					</div>
