						...
						<div class="container">
							<div class="header-landing__content">
								...
								<div class="socials">
									<div class="socials__wrapper">
										<div class="header-landing__btn">
											<a class="btn btn-main" href="https://ua.ainsys.com/my-account/" onclick="gtag( 'event', 'buttom_1', {  'event_category' : 'ain',   'event_label' : 'b_1' }); ym(86987238,'reachGoal','button_1'); return true;">Залишити заявку</a>
										</div>
								...
								<div class="header-landing__lang text-end">
									...
									<a href="#" class="header-landing__lang__current text-decoration-none">UA</a>
