...
add_filter ( 'woocommerce_account_menu_items', 'misha_log_my_acc2', 20 );
function misha_log_my_acc2( $menu_links ){
...
add_action( 'init', 'misha_add_endpoint3' );
function misha_add_endpoint3() {
	add_rewrite_endpoint( 'reg-dev', EP_PAGES );
}

add_action( 'woocommerce_account_reg-dev_endpoint', 'misha_my_acc_content4' );
function misha_my_acc_content4() {
...
<section class="my-acc">
  <div class="my-acc__container">
    ...
    <div class="my-acc-reg-form">
      <?= do_shortcode('[contact-form-7 id="3327" title="Форма регистрации разработчика"]');?>
    </div>
    ...
    <div class="my-acc-reg-cart">
      <div class="my-acc-reg-cart__wrapper">
        ...
        <div class="my-acc-reg-cart__img">
          <img src="<?php echo AINSYS_DIR_IMG ?>razrab.jpg" alt="">
        </div>
...
<div class="modal-sidebar modal-sidebar-work">
	<div class="modal modal-center modal-add-work">
		<div class="modal__wrapper modal-add-work__wrapper">
			<div class="modal-add-work__exit"><img src="<?php echo AINSYS_DIR_IMG ?>plus.svg" alt=""></div>
